...
- **github:** nested app repo, dirty local worktree as of 2026-05-26
- **default_branch:** main
- **owned_by:** shared
...
- The Forge repo has a dirty local worktree from prior sessions plus concurrent Email-tab work. Do not commit/push or restart the live Mini service until those changes are reviewed or the other session is clear.
- The Done button change is verified locally but live `com.atlas.forge-web` was not restarted from this session to avoid deploying over the concurrent Email-tab edits.
