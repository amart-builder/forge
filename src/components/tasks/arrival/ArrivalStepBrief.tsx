  ...
  return (
    <section className="mx-auto w-full max-w-[60rem] space-y-8 px-6 py-8 sm:px-10" aria-label="The brief">
      <div className="mx-auto max-w-[70ch] space-y-6">
        <div>
          ...
          {recap && (
            <div className="mt-6 space-y-2">
              ...
              <p className="text-base leading-relaxed text-foreground sm:text-lg">{recap}</p>
            </div>
          )}
        </div>

        <p className="text-base leading-relaxed text-foreground sm:text-lg">{narrative}</p>
        ...
        {watchItems.length > 0 && (
          <div className="space-y-3 pt-2" aria-label="Watching for you">
