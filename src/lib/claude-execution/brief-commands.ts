...
export function buildMorningBriefPrompt(input: {
  ...
  return [
    ...
    "SOURCE_MANIFEST tells you exactly what you can see and how fresh it is. When a source you would rely on is stale or missing (calendar and CRM last-touch are always missing today), say so plainly in lens_narrative instead of implying you checked it.",
